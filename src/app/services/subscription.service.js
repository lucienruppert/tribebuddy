...
let SubscriptionService = (() => {
    ...
    var SubscriptionService = _classThis = class {
        constructor(http) {
            this.http = http;
            this.baseUrl = environments_1.environment.BASE_URL;
        }
        subscribe(email) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const result$ = this.http.post(`${this.baseUrl}/email/add`, formData);
                    const result = yield (0, rxjs_1.firstValueFrom)(result$);
                    return result;
                }
                catch (error) {
                    const typedError = error;
                    if (typedError.error['errors'])
                        throw typedError.error['errors'];
